import 'package:calendar_bridge/calendar_bridge.dart'
    show CalendarNotFoundException, DeleteEventResult, EventNotFoundException, InvalidArgumentException, PermissionDeniedException;
...
class CalendarBridge {
  ...
  /// Note: When deleting "this and following instances", the eventId may change
  /// Throws [PermissionDeniedException] if permissions are not granted
  /// Throws [EventNotFoundException] if the event doesn't exist
